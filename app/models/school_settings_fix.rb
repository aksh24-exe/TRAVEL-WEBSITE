...
# =============================================================================
# FILE: app/models/school.rb (Model-level fix - Alternative approach)
# =============================================================================
#
# Add this callback to the School model to automatically merge settings
# on every save, preventing data loss of keys like `generate_learner_invoices`.
#
...
#   #
#   # Example:
#   #   Existing: {"title":"old","generate_learner_invoices":1}
#   #   Incoming: {"title":"new","description":"desc","favicon_url":null,"logo_url":null}
#   #   Result:   {"title":"new","generate_learner_invoices":1,"description":"desc","favicon_url":null,"logo_url":null}
#   #
